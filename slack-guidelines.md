...
* **プロフィール写真** （英語UIでは `Profile photo`）
  * なんらかの写真・画像を[行動規範](https://github.com/cto-a/community-management-resources/blob/master/code-of-conduct.md)、および、著作権法に抵触しない限りにおいて、設定してください。顔写真である方が、イベントで会った際等のコミュニケーションが円滑化して望ましいです
